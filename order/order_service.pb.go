...
type OrderInfoCreateReq struct {
	...
	RideTime      int64                  `protobuf:"varint,10,opt,name=ride_time,json=rideTime,proto3" json:"ride_time,omitempty"`
...
func (x *OrderInfoCreateReq) GetRideTime() int64 {
	if x != nil {
		return x.RideTime
	}
	return 0
...
type OrderDetail struct {
	...
	RideTime       int64                  `protobuf:"varint,23,opt,name=ride_time,json=rideTime,proto3" json:"ride_time,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *OrderDetail) GetRideTime() int64 {
	if x != nil {
		return x.RideTime
	}
	return 0
...
const file_order_service_proto_rawDesc = "" +
	...
	"\bpay_type\x18\t \x01(\x05R\apayType\x12\x1b\n" +
	"\tride_time\x18\n" +
	" \x01(\x03R\brideTime\"\xab\x01\n" +
	...
	"\x06status\x18\x06 \x01(\tR\x06status\"2\n" +
	...
	"\bend_time\x18\x03 \x01(\x03R\aendTime\"\xa0\x05\n" +
	...
	"\bend_time\x18\x16 \x01(\x03R\aendTime\x12\x1b\n" +
	"\tride_time\x18\x17 \x01(\x03R\brideTime2\xe6\x05\n" +
	"\n" +
	"order_info\x12J\n" +
