...
const (
	UserInfo_Login_FullMethodName          = "/userproto.UserInfo/Login"
	UserInfo_Register_FullMethodName       = "/userproto.UserInfo/Register"
	UserInfo_UpdatePassword_FullMethodName = "/userproto.UserInfo/UpdatePassword"
	UserInfo_UpdateInfo_FullMethodName     = "/userproto.UserInfo/UpdateInfo"
	UserInfo_GetUserInfo_FullMethodName    = "/userproto.UserInfo/GetUserInfo"
)
...
func (c *userInfoClient) UpdateInfo(ctx context.Context, in *UserInfoUpdateReq, opts ...grpc.CallOption) (*UserInfoUpdateRes, error) {
	...
	err := c.cc.Invoke(ctx, UserInfo_UpdateInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var UserInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "userproto.UserInfo",
